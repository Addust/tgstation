/obj/machinery/computer/shuttle/white_ship
	...
	shuttleId = "whiteship"
	possible_destinations = "whiteship_away;whiteship_home;whiteship_z4;whiteship_waystation;whiteship_lavaland;whiteship_custom;whiteship_hellfactory"
...
/obj/machinery/computer/camera_advanced/shuttle_docker/whiteship
	...
	jump_to_ports = list("whiteship_away" = 1, "whiteship_home" = 1, "whiteship_z4" = 1, "whiteship_waystation" = 1, "whiteship_hellfactory" = 1)
	view_range = 10
	x_offset = -6
	y_offset = -10
	designate_time = 100
